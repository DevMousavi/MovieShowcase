                ...
                {loading ? (
                    <div className="w-full">
                        <div className="relative">
                            <img
                                className="w-full rounded-3xl at:hidden sm:block sm:h-[400px] md:h-[600px]"
                        ...
                        <div>
                            <div>
                                <img
                                    className="am:m-auto am:mt-3 rounded-2xl sm:hidden lg:block lg:absolute lg:top-[600px] lg:left-0 lg:right-0 lg:bottom-0 border-[6px] am:border-primaryColor am:border-2 md:border-white border-solid"
